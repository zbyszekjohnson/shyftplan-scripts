...
for item in locations_position_id_dict_raw:
    ...
    if vehicle in ["Samochód - Warszawa"]:
...
def main():
    ...
    df_shifts = pd.read_csv("shifts_car.csv")
    ...
    for index, row in df_shifts.iterrows():
        ...
        # #TUTAJ ZMODYFIKOWAĆ TO MOCNO --- ABY POBIERAŁO Z API CALL INFO O ZMIANACH CAR RRIDERA I LUTA zeby wgrywac shift.csv

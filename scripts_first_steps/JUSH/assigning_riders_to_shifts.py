...
for shift_id, shift_info in open_shifts.items():
    ...
    if shift_type and shift_type.strip() != "" and shift_type != 'LITE' and shift_type != 'LITE\n' and shift_type != 'Cool Logistic' and shift_type != 'Zaufany Skuter\n' and shift_type != 'Jush Night':
